...
The model learns temporal patterns between air pollutants (PM2.5, NO₂, O₃, etc.) and hospital admission counts.

Achieved an RMSE accuracy of 82.3%, indicating reliable forecasting performance.
...
Gradio deployment for user interaction

🧠 Tech Stack

-Python, -PyTorch, -Pandas, -NumPy, -Matplotlib, -Gradio, -Time Series Transformers
